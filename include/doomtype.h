...
#define __BYTEBOOL__
/*
 * libtonc supplies bool/false/true on GBA.  Use its type instead of
 * declaring a second pair of global enum constants, which older libtonc
 * releases reject as a redeclaration.
 */
#if defined(GBA)
